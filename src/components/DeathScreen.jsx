...
function DeathScreen() {
	useEffect(() => {
		document.body.style.backgroundImage = "url('/public/DeathScreen.png')";
	...
	return (
		<div className="border-5 border-white w-200 m-auto text-center p-20 mt-40 rounded-4xl bg-black shadow-xl shadow-red-500/60 font-[Righteous]">
